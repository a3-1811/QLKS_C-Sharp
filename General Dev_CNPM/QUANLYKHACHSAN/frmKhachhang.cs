        ...
        private void icoBtnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (nv == null)
                    {
                        KHACH_HANG newNV = new KHACH_HANG() { MaKhachHang = "NV001", TenKhachHang = txtHoten.Text, CMND = txtCMND.Text, GioiTinh = cboGioitinh.Text, DiaChi = txtDiachi.Text, NgaySinh = DateTime.Parse(dateTimePicker1.Text), DienThoai = txtSDT.Text};
                    ...
                    else
                    {
                        ...
                        KHACH_HANG newNV = new KHACH_HANG() { MaKhachHang = maMoi, TenKhachHang = txtHoten.Text, CMND = txtCMND.Text, GioiTinh = cboGioitinh.Text, DiaChi = txtDiachi.Text, NgaySinh = DateTime.Parse(dateTimePicker1.Text), DienThoai = txtSDT.Text };
