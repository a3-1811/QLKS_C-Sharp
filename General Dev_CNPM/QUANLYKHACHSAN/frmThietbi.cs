    ...
    public partial class frmThietbi : UserControl
    {
        ...
        private void icoBtnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (tb == null)
                {
                    THIET_BI temp = new THIET_BI() { MaThietBi = "TB01", TenThietBi = txtTenthietbi.Text, SoLuong = txtSoluong.Text == "" ? 0 : int.Parse(txtSoluong.Text) };
                ...
                else
                {
                    ...
                    THIET_BI temp = new THIET_BI() { MaThietBi = maTbMoi, TenThietBi = txtTenthietbi.Text, SoLuong = txtSoluong.Text == "" ? 0 : int.Parse(txtSoluong.Text) };
                    context.THIET_BI.Add(temp);
                    context.SaveChanges();
                    loadData();
                    clearTxt();
